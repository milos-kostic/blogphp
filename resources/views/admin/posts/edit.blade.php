                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>Important-On Index Page:</label>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input 
                                                type="radio" 
                                                id="on-index-page-no" 
                                                ...
                                                class="custom-control-input"
                                                value="0"
                                                @if(0 == old('index_page', $post->index_page))
                                            checked
                                            @endif
                                            >
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input 
                                                ...
                                                class="custom-control-input"
                                                value="1"
                                                @if(1 == old('index_page', $post->index_page))
                                            checked
                                            @endif
                                            >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select 
                                            ...
                                            <option 
                                                value="{{$tag->id}}"
                                                @if(
                                                is_array(old('tag_id',$post->tags->pluck('id')->toArray())) 
...
<!--<script src="../../../../public/filemanager/bundle/filemanager.min.js" type="text/javascript"></script>-->
...
$('#entity-form [name="body"]').ckeditor({
    "height": "400px",
    //   "filebrowserBrowserUrl":  // "{{route('elfinder.ckeditor')}}",  // ruta? 
    //   
 ...
 * Delete photo
 */
$('#entity-form').on('click', '[data-action = "delete-photo"]', function (e) { // event bubbling
    e.preventDefault();
    let photo = $(this).attr('data-photo'); // citamo 2.parametar. nosi: photo ili photo2
    $.ajax({
...
// select name=tag_id // elem elece multiple: =tag_id[] - tj bas kao sto stoji za name - atrib 
...
//            },
        ...
        "description": {
            "required": true,
            "minlength": 10, //testing // "minlength": 50, 
            "maxlength": 500
        },
        "body": {
            "required": true,
