...
class CommentsController extends Controller {
    ...
    public function index(Request $request) {
        ...
        $comments = CommentsClass::getCommentsFromSession();
...
//                ->where('created_at','>=',date('Y-m-d',strtotime('-1 month')))
    ...
    public function content(Request $request) { // , Post $post) { // Route::get('/comments/content', 'App\Http\Controllers\CommentsController@content')->name('front.comments.content');
        ...
        //  dd($comments); // radi
        // return view('front._layout.partials.comments_content', [
